...
SolrClient.ADMIN_COLLECTION_HANDLER = 'admin/collection';
...
SolrClient.prototype.adminAction = function(action, query, callback){
	...
	var query = ['action='+action, query?query.toQueryString():null].join('&');
 ...
 *
 * @param {String} dir - 
 * @param {Function} done - a function executed when the Solr server responds or an error occurs
 * @api public
 */
